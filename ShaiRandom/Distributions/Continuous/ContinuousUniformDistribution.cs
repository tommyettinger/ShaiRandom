...
namespace ShaiRandom.Distributions.Continuous
{
    ...
    public sealed class ContinuousUniformDistribution : AbstractDistribution, IContinuousDistribution, IAlphaDistribution<double>, IBetaDistribution<double>
    {
        ...
        public ContinuousUniformDistribution(IEnhancedRandom generator)
        ...
        ///   <paramref name="alpha"/> is greater than <paramref name="beta"/>.
        /// </exception>
        public ContinuousUniformDistribution(IEnhancedRandom generator, double alpha, double beta)
            : base(generator)
        {
        ...
        /// </exception>
        public double Variance => MathUtils.Square(_beta - _alpha) / 12.0;
