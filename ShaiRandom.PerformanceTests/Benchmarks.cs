...
namespace ShaiRandom.PerformanceTests
{
    ...
    ///|---------------- |----------:|----------:|----------:|----------:|
    ///|        Distinct | 1.0723 ns | 0.0489 ns | 0.0775 ns | 1.0654 ns |
    ///|           Laser | 0.5720 ns | 0.0280 ns | 0.0234 ns | 0.5819 ns |
    ///|        Tricycle | 2.2213 ns | 0.0732 ns | 0.1375 ns | 2.1630 ns |
    ///|       FourWheel | 2.0651 ns | 0.0661 ns | 0.0586 ns | 2.0696 ns |
    ///|        Stranger | 2.0088 ns | 0.0659 ns | 0.1154 ns | 2.0131 ns |
    ///| XoshiroStarStar | 3.4767 ns | 0.0446 ns | 0.0417 ns | 3.4779 ns |
    ///|        RomuTrio | 4.0776 ns | 0.1070 ns | 0.1569 ns | 4.1685 ns |
    ///|         Mizuchi | 0.6449 ns | 0.0403 ns | 0.0591 ns | 0.6358 ns |
    ///|             ALF | 2.2516 ns | 0.0731 ns | 0.1355 ns | 2.2640 ns |
    ///|         MT19937 | 3.3969 ns | 0.0920 ns | 0.1228 ns | 3.3650 ns |
    ///|             NR3 | 1.5310 ns | 0.0554 ns | 0.0795 ns | 1.5131 ns |
    ///|           NR3Q1 | 0.9029 ns | 0.0447 ns | 0.0582 ns | 0.9155 ns |
    ///|           NR3Q2 | 1.1863 ns | 0.0496 ns | 0.0627 ns | 1.2047 ns |
    ///|     XorShift128 | 1.1245 ns | 0.0499 ns | 0.0762 ns | 1.1180 ns |
    ///.NET 6.0:
    ///|          Method |      Mean |     Error |    StdDev |    Median |
    ///|---------------- |----------:|----------:|----------:|----------:|
